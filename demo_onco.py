...
def main():
    ...
    save_dir = "outputs/gpt"  # Define save directory for HippoRAG objects (each LLM/Embedding model combination will create a new subdirectory)
    llm_model_name = "gpt-5-nano"  # Any OpenAI model name
